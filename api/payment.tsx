...
export async function createPayment(data: PaymentCreateInput): Promise<Payment | null> {
...
export async function updatePayment(id: number, updates: PaymentUpdateInput): Promise<Payment | null> {
  const { data, error } = await supabase
    .from('payment')
    .update(updates)
    .eq('id', id)

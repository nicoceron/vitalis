...
export default function AccountPage() {
  const { user, isLoading, orders, subscriptions } = useAuth()
          ...
          <Tabs defaultValue="profile" className="w-full">
            ...
            <TabsContent value="profile" className="space-y-6">
              <Card>
                ...
                <CardFooter>
                  <Button className="bg-emerald-700 hover:bg-emerald-800">Edit Profile</Button>
                </CardFooter>
              </Card>
                  ...
                  {subscriptions.length > 0 ? (
                    <div className="space-y-4">
                      {subscriptions.map((subscription) => (
                        <div key={subscription.id} className="flex justify-between items-center border-b pb-4">
                          <div>
                            <p className="font-medium">
                              {subscription.productId.charAt(0).toUpperCase() + subscription.productId.slice(1)}
                            </p>
                            <p className="text-sm text-gray-500 capitalize">{subscription.frequency} Plan</p>
                          </div>
                          <div className="text-right">

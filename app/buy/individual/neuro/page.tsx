...
export default function NeuroProductPage() {
  ...
  const handleAddToCart = () => {
    ...
    const item = {
      id:
        "neuro-" + (purchaseOption === "one-time" ? "single" : "subscription"),
      name: "Vitalis Neuro",
        ...
        <div className="w-full md:w-1/2 p-6 md:p-12 flex flex-col justify-center">
          <div className="max-w-md mx-auto">
            ...
            <h1 className="text-3xl md:text-4xl font-bold text-gray-900 mb-2">
              Vitalis <span className="text-emerald-700">Neuro</span>
            </h1>
            ...
            <div className="bg-white p-5 rounded-lg mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Vitalis Neuro is our premium formula supporting heart function,
                healthy circulation, and cognitive processes like memory and
                focus. A perfect complement to an active mental lifestyle.
              </p>

          ...
          <div className="max-w-md mx-auto">
            ...
            <div className="bg-white p-5 rounded-lg mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Vitalis Neuro is our premium formula designed to support brain
                function, cognitive performance, and cardiovascular health.
                Popular among professionals and older adults concerned about
                brain health.
              </p>
